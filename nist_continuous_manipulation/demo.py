...
INPUT_CSV = DATA_DIR / "measurement.csv"
CONFIDENCE = 0.95
NORMALIZATION_BOUNDS = {
    "Interception_Rate": (0.0, 1.0),
    "Search_Time": (0.0, 12.0),
    "distance": (0.0, 30.0),
}
VINCENT_GAPS = (0.05, 0.10, 0.20, 0.30)
HORIZONS = (5, 10, 20, 30, 48)
VINCENT_SIMULATORS = {
    "Interception_Rate": BetaSkewed(5.0, 1.0),
    "Search_Time": BetaSkewed(2.0, 3.0),
    "distance": BetaSkewed(2.0, 2.0),
}
