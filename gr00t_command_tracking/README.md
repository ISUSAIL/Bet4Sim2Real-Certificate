...
## Notes
- SureSim(https://arxiv.org/pdf/2510.04354) designs two algorithm to get the certificate: **SureSim** in Algorithm 2 and **SureSim(2-stage)** in Algorithm 3. In our work, we compare our method and other baseline with **SureSim**, which has a better performance compared with **SureSim(2-stage)** in their paper and experiments.
